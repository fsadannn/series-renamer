stopwords = set()
stopwords.update(['de', 'la', 'que', 'el', 'en', 'y', 'a', 'los', 'del', 'se', 'las', 'por', 'un', 'para',
                  ...
                  'nosotras', 'vosostros', 'vosostras', 'os', 'mío', 'mía', 'míos', 'mías', 'tuyo',
                  ...
                  'sintiendo', 'sentido', 'sentida', 'sentidos', 'sentidas', 'siente', 'sentid',
                  ...
                  'tenido', 'tenida', 'tenidos', 'tenidas', 'tenidas'])
stopwords.update(['i', 'me', 'my', 'myself', 'we', 'our', 'ours', 'ourselves', 'you', 'your', 'yours',
...
stopwords.update(['no', 'wa', 'the', 'ga', 'san',
                  'to', 'ni', 'na', 'kun', 'sama'])
